        ...
        <div class="container">
            <div class="congratulation-wrapper">
                <div class="congratulation-contents center-text">
                    ...
                    <p class="congratulation-contents-para"> Your password have been reseted successfully</p>
                    <div class="btn-wrapper mt-4">
                        <form method="post">
                            <input type="submit" class="cmn-btn btn-bg-1" name="submit" value="Sign in"></input>
                        </form>
